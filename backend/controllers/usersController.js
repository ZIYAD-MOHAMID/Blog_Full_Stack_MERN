...
const {
  ...
  cloidinaryRemoveImages,
} = require("../Utils/clousinary.js");
 ...
 * @router  /api/users/profile/:id
 * @method  PUT
 * @access  private (only rser himself)
 ------------------------------------------*/
 ...
 * @access  private (only logged in user)
 ------------------------------------------*/
module.exports.profilPhotoUploadCtrl = asyncHandler(async (req, res) => {
  //1, Validation
  if (!req.file) {
